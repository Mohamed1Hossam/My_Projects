...
tk.Label(input_frame, text="Processes:").grid(row=0, column=0, padx=5, pady=5)
entry_count = tk.Entry(input_frame, width=20)
entry_count.grid(row=0, column=1, padx=5, pady=5)

tk.Label(input_frame, text="Burst Times (separated by spaces):").grid(row=1, column=0, padx=5, pady=5)
